...
('CRI', 'Costa Rica', 'Central America', 'Central America', 51100, 1821, 4023000, 75.8, 10226.00, 9757.00, 'Costa Rica', 'Republic', 'Miguel �ngel Rodr�guez Echeverr�a', 584, 'CR'),
...
ALTER TABLE "public"."city" ADD FOREIGN KEY ("countrycode") REFERENCES "public"."country"("code") ON DELETE CASCADE;
ALTER TABLE "public"."countrylanguage" ADD FOREIGN KEY ("countrycode") REFERENCES "public"."country"("code") ON DELETE CASCADE;


select  distinct continent from country order by continent asc;
-- insert datos simulataneamente
...
CREATE TABLE public.country_bk (
	...
	CONSTRAINT country_pkey_bk PRIMARY KEY (code),
...
--------
	select 
		a."name", 
		a.continent,
		(select c.code from continent c where c.name = a.continent),
		(select c.name from continent c where c.name = a.continent)
	from country a;


update 
	country a
set continent = (select c.code from continent c where c.name = a.continent);
